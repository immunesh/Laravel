...
<div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5 dashboard-content">
                    ...
                    <div class="submit-address dashboard-list">
                        ...
                        @endif
                        <form method="POST" action="{{url('store_property')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker search-fields" name="city" id="city_name" onchange="city_select()" >
                                            ...
                                            <option {{ old('state') == 'Madhya Pradesh'? 'selected':''}}>Jabalpur</option>
                                            <option {{ old('state') == 'Maharashtra'? 'selected':''}}>Indore</option>
                                        </select>
                                    </div>
                                </div>
                                 <div class="col-lg-4 col-md-4 col-sm-12">
                            ...
                            <div class="row pad-20">
                                <div class="col-lg-12">
                                    <textarea name="description" class="form-control" placeholder="Detailed Information"></textarea>
                                </div>
                            </div>
