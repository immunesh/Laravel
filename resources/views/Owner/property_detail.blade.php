...
<div class="properties-details-page content-area">
                ...
                <div class="col-lg-12 mb-40">
                    <div class="button-section">
                        @if(Auth::check())
                            ...
                            <form method="get"  class="col-md-12" id="formafterMath" action="{{url('property_booking')}}" 
                  >
                  <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                       <input type="hidden" name="do_data" id="do_data" value="">
 ...
 <button type="submit" id="rzp-button1" class="btn btn-success btn-lg" style="cursor: pointer;"  >Booking</button>
           @endif                  
                        @else
                            <a href="{{url('login')}}" class="btn btn-success btn-lg">Contact Owner</a>
                            <a href="{{url('login')}}" class="btn btn-success btn-lg">Schedule Appointment</a>
...
function appointment(id){
    ...
    $.ajax({
            ...
            success: function(res){
                ...
                console.log(res.appoint_status);
            }     
          });
}
</script>
...
var options = {
    ...
    "amount": 200000 , //  = INR 1
    "name": "RentoBro Booking",
    "description": "Paying using Razorpay to for booking .",
  
    "handler": function (response){
         $('#do_data').val(response.razorpay_payment_id);


         $("#formafterMath").submit();
    },
    "prefill": {
        "name": "sss",
        "email":  ""
