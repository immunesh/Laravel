                    ...
                    <div class="dashboard-content">
                        ...
                        @endif
                            ...
                            <div class="dashboard-message contact-2 bdr clearfix">
                                <form action="{{url('owner/editprofile/'.$user->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="dashboard-list">
                                    ...
                                    <div class="dashboard-message contact-2">
                                        <form action="{{url('/owner/change_pass/'.$user->id)}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group name">
