...
<div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5">
                    <div class="dashboard-content">
                        ...
                        @endif
                        @if($subs != null)
                            @if($subs->no_of_lead < $subs->lead_used)
                            <div class="alert alert-danger alert-2" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <strong>Plan Used</strong> Your Plan is totally used <a href="{{url('owner/pricing')}}" style="color: blue">Click Here</a> subscribe a new Plan
                            </div>
                            @else
