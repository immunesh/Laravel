                            ...
                            <div class="row pad-20">
                                <div class="col-lg-12">
                                    @if(count($agreements) != 0)
                                        ...
                                        @endforeach
                                    @else
                                        <h3>Sorry! Rentobro not send you any Property agreement Click here <a href="{{url('submit_property')}}" class="btn btn-theme btn-md"> Submit Property</a>  to add more Property</h3>
                                    @endif
                                </div>
                            </div>
                        </form>
