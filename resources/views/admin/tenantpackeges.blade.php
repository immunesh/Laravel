...
<div class="col-lg-9 col-md-12 col-sm-12 col-pad">
                <div class="content-area5 dashboard-content">
                    <div class="dashboard-header clearfix">
                        <div class="row">
                            <div class="col-sm-12 col-md-6"><h4>Tenant Packages</h4></div>
                            <div class="col-sm-12 col-md-6">
                                <div class="breadcrumb-nav">
                                    <ul>
                                        ...
                                        <li class="active">Tenant Packages</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="submit-address dashboard-list">
                        <form method="GET">
                            ...
                            @endif
                            <h4>Tenant Packages List</h4>
                            <div class="row pad-20">
                                <div class="col-lg-12">
                                    @if(count($t_package) != 0)
                                        ...
                                        @endforeach
                                    @else
                                        <h3>Tenant Not Subscribed any Plan</h3>
                                    @endif
                                </div>
                            </div>
                        </form>
